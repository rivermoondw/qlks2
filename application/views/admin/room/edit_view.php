            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="rank_id" style="width: 100%;">
                        ...
                        foreach ($rank as $key => $val) {
                            echo '<option value="' . $val['rank_id'] . ';" ';
                            if ($room['rank'] == $val['rank']) {
                                echo 'selected="selected"';
                            }
                            echo '>' . $val['rank'] . '</option>';
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Nhập giá phòng" name="price"
                           value="<?php echo set_value('price', $room['price']); ?>">
                </div>
            </div>
            <!-- /.box-body -->
