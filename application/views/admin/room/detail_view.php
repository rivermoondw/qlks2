...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                <a href="<?php echo base_url(); ?>admin/payment/detail/<?php echo $booking_id;?>"><button type="button" class="btn btn-success" id="confirm"><i class="fa fa-check"></i> Trả phòng</button></a>
            </div>
        </div>
    </div>
</div>
                    ...
                    if (isset($list_service) && count($list_service)){
                        foreach ($list_service as $key => $val){
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>admin/booking/del_service/<?php echo $val['bookingroom_id']; ?>"><button type="button" class="btn btn-default btn-xs del-btn"><i class="fa fa-times"></i> Xóa</button></a></td>
                            </tr>
                            <?php
                        }
                    }
