        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <table id="example2" class="table table-hover">
                    ...
                    ?>
                    <tr>
                        <td><input type="checkbox" name="checkbox[]" value="<?php echo $val['utility_id']; ?>"></td>
                        <td><?php echo htmlspecialchars($val['utility']); ?></td>
                        <td>
                            <a href="<?php echo base_url(); ?>admin/utility/edit/<?php echo $val['utility_id']; ?>"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-edit"></i> Sửa</button></a>
                            <a href="<?php echo base_url(); ?>admin/utility/del/<?php echo $val['utility_id']; ?>"><button type="button" class="btn btn-default btn-xs del-btn"><i class="fa fa-times"></i> Xóa</button></a>
                        </td>
                    </tr>
                    <?php
                        }
            ...
            <div class="box-footer no-border">
                ...
                <a href="<?php echo base_url(); ?>admin/utility/add"><button type="button" class="btn btn-default"><i class="fa fa-plus"></i> Thêm tiện nghi</button></a>
